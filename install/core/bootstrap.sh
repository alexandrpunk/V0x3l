step_0() {
    ...
    run_cmd "apt install base" root apt install -y nala wget tar unzip file zsh git dialog apt-utils curl ca-certificates pciutils locales gnupg software-properties-common || true
    nospin

...
echo "🖥️ [2/11] Instalando stack Wayland y drivers gráficos..."
...
echo "📁 [3/11] Instalando Nautilus mínimo y backend de montaje..."
nala install --no-install-recommends -y \
...
echo "📦 [4/11] Instalando paquetes adicionales..."
...
echo "🔊 [5/11] Configurando audio, red, bluetooth y optimizando el inicio..."
nala install --no-install-recommends -y \
...
echo "🎬 [6/11] Instalando códecs multimedia y thumbnails..."
nala install --no-install-recommends -y \
...
echo "📦 [7/11] Instalando y configurando Flatpak..."
...
echo "⚙️ [8/11] Habilitando servicios y configurando entorno Wayland..."
...
# 9. Oh My Zsh + Nerd Fonts
echo "🐚 [9/11] Instalando Oh My Zsh, tema agnoster y Nerd Fonts..."
...
# 10. INSTALAR TEMA PLYMOUTH DESDE ZIP LOCAL
echo "🎨 [10/11] Instalando tema Plymouth desde archivo local..."
...
# 11. EJECUCIÓN DEL ASISTENTE DANK LINUX
echo ""
echo "🚀 [11/11] Iniciando asistente de instalación de Dank Material Linux..."
